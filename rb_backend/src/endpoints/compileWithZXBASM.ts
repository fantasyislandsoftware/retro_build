...
export const compileWithZXBASM = (app: any) => {
  app.post("/compileWithZXBASM", async (req: any, res: any, next: any) => {
    /* Get params */
    let { name } = req.body;
    ...
    const cmd = `/home/node/app/bin/linux/compilers/zxbasic/./zxbasm.py ${workspacePath}/${dirList[fileInfo.src.path]}/${
